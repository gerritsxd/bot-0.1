...
import click
from schnapsen.bots import train_ML_model, MLPlayingBot, MLDataBot
from schnapsen.bots import OkiDataBot, OkiPlayingBot, train_Oki_model, RandBot
...
def create_replay_memory_dataset() -> None:
    ...
    num_of_games: int = 500000
    replay_memory_dir: str = 'ML_replay_memories'
    replay_memory_filename: str = 'ml_bot_rand_rand_500k_games.txt'
...
def train_model() -> None:
    ...
    model_name: str = 'ml_bot_rand_rand_500k_games_NN_model'
